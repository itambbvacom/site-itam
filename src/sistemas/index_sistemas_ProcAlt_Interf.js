...
function getdata() {
	...
	*/
	...
	/* Hojas de QA */
	/* https://drive.google.com/open?id=1fAsAMmTxLcUua8abvQYM3pehuf76E54isulULbwrCzA */ 
	/* https://docs.google.com/spreadsheets/d/1fAsAMmTxLcUua8abvQYM3pehuf76E54isulULbwrCzA/edit#gid=1 */
	/* var query = new google.visualization.Query('https://spreadsheets.google.com/a/bbva.com/tq?&tq=&key=1fAsAMmTxLcUua8abvQYM3pehuf76E54isulULbwrCzA&gid=1');
	query.send(handleQueryResponse); */
	
	/* https://docs.google.com/spreadsheets/d/1fAsAMmTxLcUua8abvQYM3pehuf76E54isulULbwrCzA/edit#gid=48 */
	/* var queryManuals = new google.visualization.Query('https://spreadsheets.google.com/a/bbva.com/tq?&tq=&key=1fAsAMmTxLcUua8abvQYM3pehuf76E54isulULbwrCzA&gid=48');
	queryManuals.send(handleQueryResponseManuals); */
	
	/* https://docs.google.com/spreadsheets/d/1fAsAMmTxLcUua8abvQYM3pehuf76E54isulULbwrCzA/edit#gid=1441491815 */
	/* var queryGAPS = new google.visualization.Query('https://spreadsheets.google.com/a/bbva.com/tq?&tq=&key=1fAsAMmTxLcUua8abvQYM3pehuf76E54isulULbwrCzA&gid=1441491815');
	queryGAPS.send(handleQueryResponseGAPS); */ 
	
	/* */
	
	/* Hojas de PRODUCCIÓN 
	https://docs.google.com/spreadsheets/d/10goxooWZh8lZhSVaOU7WSfBTcuDsE3RgP6pZCKBhyv0/edit#gid=1
	*/
	var query = new google.visualization.Query('https://spreadsheets.google.com/a/bbva.com/tq?&tq=&key=10goxooWZh8lZhSVaOU7WSfBTcuDsE3RgP6pZCKBhyv0&gid=1');
	query.send(handleQueryResponse);
	
	/* https://docs.google.com/spreadsheets/d/10goxooWZh8lZhSVaOU7WSfBTcuDsE3RgP6pZCKBhyv0/edit#gid=48 */
	var queryManuals = new google.visualization.Query('https://spreadsheets.google.com/a/bbva.com/tq?&tq=&key=10goxooWZh8lZhSVaOU7WSfBTcuDsE3RgP6pZCKBhyv0&gid=48');
	queryManuals.send(handleQueryResponseManuals);
	
	/* https://docs.google.com/spreadsheets/d/10goxooWZh8lZhSVaOU7WSfBTcuDsE3RgP6pZCKBhyv0/edit#gid=1441491815 */
	var queryGAPS = new google.visualization.Query('https://spreadsheets.google.com/a/bbva.com/tq?&tq=&key=10goxooWZh8lZhSVaOU7WSfBTcuDsE3RgP6pZCKBhyv0&gid=1441491815');
	queryGAPS.send(handleQueryResponseGAPS);
